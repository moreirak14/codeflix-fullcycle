...
import unittest
from __seedwork.application.dto import PaginationOutput, PaginationOutputMapper, SearchInput, Filter, Item
...
class TestPaginationOutputMapper(unittest.TestCase):
    ...
    def test_to_output(self):
        ...
        output = PaginationOutputMapper.from_child(
            output_child=PaginationOutputChild).to_output(items=result.items, result=result)
